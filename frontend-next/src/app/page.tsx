...
export default function Home() {
  return (
    <div className="space-y-8 lg:space-y-10">
      <section className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.03] p-4 shadow-[0_24px_70px_rgba(0,0,0,0.35)] sm:p-6 md:p-8">
        <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div className="space-y-5">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.06] px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-white/75">
              <LayoutDashboard className="h-3.5 w-3.5 text-[#ffd700]" />
              AI Powered Career Guidance
            </div>
            <div className="space-y-3">
              <h1 className="max-w-4xl text-3xl font-black uppercase tracking-[0.08em] text-white sm:text-4xl md:text-5xl lg:text-6xl">
                Resume Analyser and Internship Recommendation System
              </h1>
              <p className="max-w-3xl text-sm leading-7 text-white/65 sm:text-base md:text-lg">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
            <div className="rounded-[1.5rem] border border-white/10 bg-black/45 p-4">
              <div className="relative mx-auto mb-5 h-28 w-full max-w-sm overflow-hidden rounded-[1rem] border border-white/10 bg-white">
                <Image
                  src="/snu-logo.png"
